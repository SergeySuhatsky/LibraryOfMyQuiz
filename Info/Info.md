...
Когда у тебя готов файл Markdown и установлен Pandoc, нужно открыть терминал (или командную строку) в папке с твоим файлом и ввести эту команду, при этом тебе обязательно подтянуть файлик Ворд ref.docx из этого репозитория, в менюшке слева найдёшь:
